...
.title-slide h1 {
  ...
  color: #732929;  /* Cambio del color del texto a morado */
   position: absolute;
...
.side-text {
  color: #732929;  /* Cambio del color del texto lateral a morado */
...
.side-text a {
  color: #732929;  /* Cambio del color de los enlaces a morado */
}
...
.title-where {
  ...
  position: absolute;
  bottom: 10px;
  color: #732929;  /* Cambio del color del texto de ubicación a morado */
}
